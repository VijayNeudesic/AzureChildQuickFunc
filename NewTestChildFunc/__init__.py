...
def main(req: func.HttpRequest) -> func.HttpResponse:
    function_name = "NewTestChildFunc"
    ...
    if name:
        try:
            ...
            # Format greeting with last name (as hinted in the original message)
            greeting = format_greeting(validated_name, include_lastname=True)
